...
try:
    ...
    print('You need to install the bext module.')
    print('Get it from: http://pypi.python.org/pypi/bext')
    sys.exit()

# Setting up constants
WIDTH, HEIGHT = bext.size()
# We can't print to the last column without it adding a newline, so reduce width by 1
WIDTH -=1
...
def main():
    ...
    cornerBounces = 0 # Count how many times a logo hits the corner of the screen
    while True: # Main program loop
        for logo in logos: # Handle each logo in the logos list
            # Erase the current location of the logo
